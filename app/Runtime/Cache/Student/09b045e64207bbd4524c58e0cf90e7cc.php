...
<div id="leftbox">
	...
	<div id="box2">
		...
		<span><p>欢迎：</p><p><?php echo ($_SESSION['snum']); ?></p><p>状态:<em class="box21">在线</em></p>
	</div>
	<hr width="262px" bgcolor="black" float="left">
	<div id="nav">
		<ul>
			<a class="nav1" href="<?php echo U(GROUP_NAME.'/Index/person');?>" target="rightFrame"><span></span><li  class="selected">学生个人信息</li></a>
			...
			<a class="nav6" href="<?php echo U(GROUP_NAME.'/Index/onup');?>" target="rightFrame"><li>个人证件上传下载</li></a>
