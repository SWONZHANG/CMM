...
<div id="leftbox">
	...
	<div id="box2">
		...
		<span><p>欢迎：</p><p><?php echo ($_SESSION['tnum']); ?></p><p>状态:<em class="box21">在线</em></p>
	</div>
	<hr width="262px" bgcolor="black" float="left">
	<div id="nav">
		<ul>
			<a class="nav1" href="<?php echo U(GROUP_NAME.'/Index/person');?>" target="rightFrame"><li  class="selected">
			教师个人信息</li></a>
